...
function wrappedAmount(currencyAmount, chainId) {
  ...
  if (currencyAmount.currency.symbol === CAVAX.symbol) return new TokenAmount(WAVAX[chainId], currencyAmount.raw);
    invariant(false, 'CURRENCY')  ;
}

function wrappedCurrency(currency, chainId) {
  if (currency instanceof Token) return currency;
  if (currency.symbol === CAVAX.symbol) return WAVAX[chainId];
    invariant(false, 'CURRENCY')  ;
}
/**
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency.symbol === CAVAX.symbol;
    var etherOut = trade.outputAmount.currency.symbol === CAVAX.symbol; // the router does not support both ether in and out
